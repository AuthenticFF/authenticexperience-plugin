...
use authenticff\authenticexperience\assetbundles\smartphotospherefield\SmartPhotosphereFieldAsset;
 ...
 * @since     0.1
 */
class SmartPhotosphere extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('authentic-experience', 'SmartPhotosphere');
    }
    ...
    public function normalizeValue($value, ElementInterface $element = null)
    {
      ...
      if (is_string($value))
      {
        $smartPhotosphereData = json_decode($value, true);
      }

      else
      {
        $smartPhotosphereData = $value;
      }

      return $smartPhotosphereData;
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'authentic-experience/_components/fields/SmartPhotosphere_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
      ...
      if(isset($value["smartPhotosphereFeatures"]) && ! empty($value["smartPhotosphereFeatures"]))
      {

        foreach ($value["smartPhotosphereFeatures"] as $key => $feature)
        {
      ...
      if( ! empty($value["smartPhotosphereAsset"]) ){
        $assetElements = \craft\elements\Asset::find()->id($value["smartPhotosphereAsset"]);
      }

      // Register our asset bundle
      Craft::$app->getView()->registerAssetBundle(SmartPhotosphereFieldAsset::class);
      ...
      //
      $smartPhotosphereAssetName = $this->handle . "[smartPhotosphereAsset]";
      $smartPhotosphereAssetId = Craft::$app->getView()->formatInputId("smartPhotosphereAssetId");
      $smartPhotosphereAssetNamespacedId = Craft::$app->getView()->namespaceInputId($smartPhotosphereAssetId);

      $smartPhotosphereFeaturesName = $this->handle . "[smartPhotosphereFeatures]";
      $smartPhotosphereFeaturesId = Craft::$app->getView()->formatInputId("smartPhotosphereFeaturesId");
      $smartPhotosphereFeaturesNamespacedId = Craft::$app->getView()->namespaceInputId($smartPhotosphereFeaturesId);

      //
      // Variables for javascript
      //
      $jsonVars = [
        'smartPhotosphereAssetName' => $smartPhotosphereAssetName,
        'smartPhotosphereAssetId' => $smartPhotosphereAssetId,
        'smartPhotosphereAssetNamespacedId' => $smartPhotosphereAssetNamespacedId,
        'smartPhotosphereAssetElements' => $value["smartPhotosphereAsset"],
        'smartPhotosphereAssetElementType' => Asset::class,
        'smartPhotosphereFeaturesName' => $smartPhotosphereFeaturesName,
        'smartPhotosphereFeaturesId' => $smartPhotosphereFeaturesId,
      ...
      //
      $variables = [];
      $variables["smartPhotosphereAssetName"] = $smartPhotosphereAssetName;
      $variables["smartPhotosphereAssetId"] = $smartPhotosphereAssetId;
      $variables["smartPhotosphereAssetNamespacedId"] = $smartPhotosphereAssetNamespacedId;
      $variables["smartPhotosphereAssetElements"] = $assetElements;
      $variables["smartPhotosphereAssetElementType"] = Asset::class;
      $variables["smartPhotosphereAssetSources"] = ["handle:". "experience"];

      $variables["smartPhotosphereFeaturesName"] = $smartPhotosphereFeaturesName;
      ...
      return Craft::$app->getView()->renderTemplate(
          'authentic-experience/_components/fields/SmartPhotosphere_input',
          $variables
      );
